...
<svelte:window onscroll={isLogoInViewport} />

<section class="c-header" class:has-logo={$page.url.pathname !== '/'} bind:this={header}>
  <div class="c-header__inner">
    <a class="c-header__link" href="/" onclick={onLogoClick} >
